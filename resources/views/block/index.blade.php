                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#tukang" data-toggle="tab">Tukang</a></li>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="payment">
                                    <div class="row">
                                        <button type="button" class="btn btn-success btn-sm mb-3 mr-3" data-toggle="modal"
                                            data-target="#modal-add-payment-history">
                                            <i class="nav-icon fas fa-plus-circle"></i>&nbsp;
                                            Tambah Pembayaran Baru
                                        </button>
                                        <a href="{{ route('payment.additionalItem', $result->id) }}" class="btn btn-info btn-sm mb-3">
                                            <i class="nav-icon fas fa-plus-circle"></i>&nbsp;
